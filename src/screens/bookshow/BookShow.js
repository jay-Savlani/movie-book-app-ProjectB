...
import { Typography ,Card, CardContent, FormControl, InputLabel, Input, Select, MenuItem, Button, FormHelperText } from "@mui/material";
...
const BookShow = (props) => {
  ...
  useEffect(() => {
    ...
    fetch(props.rootUrl + "movies/" + id + "/shows", {
      method: "GET",
      headers: {
        ...
        <Card className="cardStyle">
          <CardContent>
            ...
            <FormControl required className="formControl">
              ...
              <Select variant='standard' value={location} onChange={locationChangeHandler}>
                {locations.map((loc) => (
            ...
            <FormControl required className="formControl">
              ...
              <Select variant='standard' value={theatre} onChange={theatreChangeHandler}>
                {theatres.map((th) => (
            ...
            <FormControl required className="formControl">
              ...
              <Select variant='standard' value={language} onChange={languageChangeHandler}>
                {languages.map((lang) => (
            ...
            <FormControl required className="formControl">
              ...
              <Select variant='standard' value={showDate} onChange={showDateChangeHandler}>
                {showDates.map((sd) => (
